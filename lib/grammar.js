 ...
 * @generatedfrom ./grammar.macro.js#79ddd2998454ee246c86169862a446d88dce830d
...
export const grammar = class VerboseOutputGrammar {
  ...
  *Line() {
    yield eat(m`<__Any />`, [m`<ExecInstructionLine /(?:    )?\>\>\>/ />`, m`<EmitLine '<<<' />`, m`<EnterProductionLine '-->' />`, m`<LeaveProductionLine /[x<]--/ />`, m`<OutputLine /./s />`]);
  }
  *ProductionName() {
