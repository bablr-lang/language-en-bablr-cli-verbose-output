 ...
 * @generatedfrom ./grammar.macro.js#31c081962d89e0ab315f7458dc83fa2dea499f03
...
export const grammar = class VerboseOutputGrammar {
  ...
  *Line() {
    yield eat(m`<Any />`, [m`<ExecInstructionLine /(    )?\>\>\>/ />`, m`<EmitLine '<<<' />`, m`<EnterProductionLine '-->' />`, m`<LeaveProductionLine /[x<]--/ />`, m`<OutputLine />`]);
  }
  *ProductionName() {
